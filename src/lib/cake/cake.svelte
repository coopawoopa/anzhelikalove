<script lang="ts">
	// No JavaScript needed since we’re ignoring the flame toggle
</script>

<div
	style="display: flex; justify-content: center; align-items: center; height: 100vh; position: absolute; width: 100vw;"
>
	<div class="cake">
		<div class="candle">
